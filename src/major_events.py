...
from .switches import get_switch_state # to jest zmienna przełącznika, która będzie sprawdzana w każdym momencie
...
def wazne_wydarzenia(kot): # definicja funkcji 
    while True:
        ...
        wydarzenie = random.choice(["najedz_down2", "przynalez_down2", "najedz_up2", "przynalez_up2", "dobrostan_emo_down2", "dobrostan_emo_up2"]) # losowanie wydarzenia
